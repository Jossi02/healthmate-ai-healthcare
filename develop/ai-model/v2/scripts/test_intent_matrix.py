...
CASES: list[Case] = [
    ...
    Case("record", "record_calendar_delete_all_reversed", "모두 제거해줘 캘린더 내용", "record", "general", expected_record_type="plan_delete"),
    ...
    Case("safety", "safety_chest_sweat_continue", "운동하다가 가슴이 답답하고 식은땀이 나. 계속해도 돼?", "safety", "general"),

...
_CASUAL_INTRO_MESSAGES = {
    ...
    "cheer_sis": (
        ...
        "수정과 삭제까지 도와드릴게요. 좋아요, 부담 줄여서 가요. 이 정도면 충분해요."
    ),
    "soft_senior": (
        "저는 FitUs에서 운동과 식단을 무리 없게 정리해드리는 AI 코치입니다. 플랜 작성, 캘린더 반영, "
        "수정과 삭제를 차분히 도와드리겠습니다. 괜찮습니다. 필요한 항목만 정리해도 됩니다."
    ),
    "strict_trainer": (
        "나는 FitUs AI 코치다. 운동 플랜, 식단 플랜, 캘린더 반영, 수정과 삭제를 바로 처리한다. "
        "원하는 목표만 말해. 안전 기준만 보고 바로 가. 무리는 빼."
    ),
    "science_coach": (
        "저는 FitUs의 분석형 AI 코치입니다. 기준은 프로필, 일정, 안전성입니다. "
        "운동과 식단 플랜 구성입니다. 근거는 실행 부담과 지속 가능성입니다."
    ),
    "playful_buddy": (
        "나는 FitUs에서 운동이랑 식단을 같이 맞춰보는 AI 코치야. 플랜 짜기, 캘린더 반영, 수정과 삭제까지 "
        "도와줄 수 있어. 괜찮아, 너무 무겁지 않게 같이 가보자."
    ),
    "daily_manager": (
        "저는 FitUs 일정 관리형 AI 코치입니다. 운동 플랜, 식단 플랜, 캘린더 반영, 수정과 삭제를 "
        "정리해서 처리해드립니다. 확인했습니다. 반영 범위는 운동, 식단, 캘린더 항목입니다."
    ),
}

_CASUAL_ACK_MESSAGES = {
    "default": "알겠어요. 필요한 것만 짧게 이어서 도와드릴게요.",
    "cheer_sis": "좋아요. 부담은 낮추고 필요한 것만 밝게 맞춰볼게요. 이 정도면 충분해요.",
    "soft_senior": "괜찮습니다. 무리 없게 천천히 이어가도 됩니다.",
    "strict_trainer": "확인. 필요한 것만 바로 해. 무리는 빼.",
    "science_coach": "확인했습니다. 기준은 요청 범위입니다. 근거는 필요한 답만 남기는 쪽입니다.",
    "playful_buddy": "좋아, 괜찮아. 부담 낮게 같이 이어가보자.",
    "daily_manager": "확인했습니다. 반영 범위는 필요한 항목입니다. 정리해서 이어가겠습니다.",
}

_CASUAL_THANKS_MESSAGES = {
    "default": "천만에요. 다음 것도 편하게 말해 주세요.",
    "cheer_sis": "좋아요, 언제든 편하게 말해 주세요. 같이 맞춰볼게요.",
    "soft_senior": "괜찮습니다. 필요하실 때 편하게 말씀해도 됩니다.",
    "strict_trainer": "좋다. 다음 것도 바로 말해. 무리는 빼.",
    "science_coach": "도움이 됐다면 좋습니다. 다음 질문도 기준은 명확하게 잡아 답하겠습니다.",
    "playful_buddy": "언제든 말해. 괜찮아, 같이 하나씩 해보자.",
    "daily_manager": "확인했습니다. 다음 요청도 처리 항목입니다. 바로 정리해드리겠습니다.",
}

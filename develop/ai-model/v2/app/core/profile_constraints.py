...
_NEGATED_CONSTRAINT_PATTERNS = (
    ...
    ("kidney_disease", _negated_pattern(r"신장질환|신장\s*질환|콩팥|만성신부전|ckd|kidney disease|renal")),
    ("gout", _negated_pattern(r"통풍|요산|gout|uric acid")),
    ("pregnancy", _negated_pattern(r"임신|임산부|pregnant|pregnancy")),
    ("eating_disorder_risk", _negated_pattern(r"폭식|절식|섭식장애|섭식\s*장애|eating disorder")),

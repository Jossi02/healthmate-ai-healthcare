export const AI_PERSONAS = [
  ...
  },
  {
    ...
    name: "다정 동생",
    shortLabel: "동생",
    description: "조용히 곁에서 챙겨주는 다정한 동생",
    tone: "부드럽고 살뜰한 응원",
    intro:
      "오늘도 와줘서 좋아요. 제가 옆에서 차분히 같이 볼게요. 지금 가능한 만큼만 말해줘도 괜찮아요.",
    profileLine:
      "지친 날에도 사용자의 속도를 존중하면서 살뜰하게 챙겨주는 코치예요.",
    imageSrc: "/personas/soft_senior.jpg",
    imageAlt: "부드럽게 챙겨주는 다정 동생 아바타",
  ...
  },
  {
    ...
    name: "루틴 장인",
    shortLabel: "루틴",
    description: "반복 가능한 루틴으로 정리하는 실행형 코치",
    tone: "규칙적이고 실용적인 정리",
    intro:
      "좋습니다. 오늘 기준으로 반복 가능한 루틴을 맞춰볼게요. 목표, 시간, 컨디션 중 무엇부터 정리할까요?",
    profileLine:
      "복잡한 계획을 반복 가능한 운동·식단 루틴으로 고정해주는 코치예요.",
    imageSrc: "/personas/science_coach.jpg",
    imageAlt: "루틴을 체계적으로 정리하는 루틴 장인 아바타",
...
export const PERSONA_CHAT_STARTERS = [
  {
    label: "운동 플랜 작성",
    prompt: "일주일 운동 플랜을 내 상태에 맞춰서 짜줘",
  },
  {
    label: "식단 플랜 작성",
    prompt: "일주일 식단 플랜을 내 상태에 맞춰서 짜줘",
  },
] as const;
